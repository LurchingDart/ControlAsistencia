...
const Formulario = () => {
  ...
  useEffect(() => {
    axios
      .get("https://api-control-asistencia.vercel.app/api/grupo", {
    ...
    axios
      .get("https://api-control-asistencia.vercel.app/api/materia", {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((res) => {
    ...
    axios
      .get("https://api-control-asistencia.vercel.app/api/profesor", {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((res) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .get(
        `https://api-control-asistencia.vercel.app/api/estudiante/check/${matricula}`,
        { headers: { Authorization: `Bearer ${token}` } }
      )
      .then((res) => {
        if (res.data) {
          ...
          axios
            .get(
              `https://api-control-asistencia.vercel.app/api/estudiante/studentId/${matricula}`,
              { headers: { Authorization: `Bearer ${token}` } }
            )
            .then((res) => {
              ...
              axios
                .post(
                  "https://api-control-asistencia.vercel.app/api/asistencia",
                  data,
                  { headers: { Authorization: `Bearer ${token}` } }
                )
                .then((res) => {
          ...
          axios
            .post(
              "https://api-control-asistencia.vercel.app/api/estudiante",
              data,
              { headers: { Authorization: `Bearer ${token}` } }
            )
            .then((res) => {
